...
void arm_set_height(enum Height height) {
  switch (height) {
    ...
    case ARM_BACK_PLATE:
        ...
        wb_motor_set_position(arm_elements[ARM3], 2.4);
    ...
    case ARM_SHRINK1:
        ...
        break;
    case ARM_SHRINK2:
        wb_motor_set_position(arm_elements[ARM2], -1.13);
        wb_motor_set_position(arm_elements[ARM3], 2.55);
        wb_motor_set_position(arm_elements[ARM4], -1.78);
        wb_motor_set_position(arm_elements[ARM5], 0.0);
        break;
    case ARM_GRASP_VERTICAL:
        ...
        wb_motor_set_position(arm_elements[ARM5], 0.0);
        break;
    case ARM_GRASP_HORIZONTAL:
        wb_motor_set_position(arm_elements[ARM2], -1.13);
        wb_motor_set_position(arm_elements[ARM3], -2.25);
        wb_motor_set_position(arm_elements[ARM4], 1.78);
        wb_motor_set_position(arm_elements[ARM5], 0.0);
        // Gripper Height = 0.182
        break;
    case ARM_HOLD_STEP1:
    ...
    case ARM_HOLD_STEP2:
        ...
        wb_motor_set_position(arm_elements[ARM4], 0.0);
        wb_motor_set_position(arm_elements[ARM5], 0.0);
        break;
    case ARM_SHELF_HIGH:
        wb_motor_set_position(arm_elements[ARM2], 0.0);
    ...
    case ARM_SHELF_MIDDLE:
        wb_motor_set_position(arm_elements[ARM2], 0.4);
        wb_motor_set_position(arm_elements[ARM3], -2.2);
        wb_motor_set_position(arm_elements[ARM4], 0.2);
        wb_motor_set_position(arm_elements[ARM5], 0.0);
        break;
    case ARM_SHELF_LOW_STEP1:
        wb_motor_set_position(arm_elements[ARM2], 0.0);
        wb_motor_set_position(arm_elements[ARM3], -2.25);
        wb_motor_set_position(arm_elements[ARM4], 1.78);
        wb_motor_set_position(arm_elements[ARM5], 0.0);
        break;
    case ARM_SHELF_LOW_STEP2:
        wb_motor_set_position(arm_elements[ARM2], -1.13);
        wb_motor_set_position(arm_elements[ARM3], -2.25);
        wb_motor_set_position(arm_elements[ARM4], 1.78);
        wb_motor_set_position(arm_elements[ARM5], 0.0);
